...
@Component
public class UserRegisterFinishListener implements SmartApplicationListener{

    Logger logger = LoggerFactory.getLogger(UserRegisterFinishListener.class);
    /**
    ...
    public void onApplicationEvent(ApplicationEvent applicationEvent) {
        ...
        //.../完成注册业务逻辑
        logger.info("【order: {}】 - 用户注册完成，返回首页", getOrder());
//        System.out.println("【order:】 "+ getOrder() +" - 注册信息，用户名："+user.getName()+"，密码："+user.getPassword());
    }
